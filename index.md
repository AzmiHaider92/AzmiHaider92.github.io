...
**PhD researcher** at the University of Haifa, advised by [Dan Rosenbaum](https://danrsm.github.io/), working on computer vision and generative modeling, focusing on fast probabilistic inference and guided generation with token-based neural representations. Research includes controllable generative processes across modalities, including 3D scene understanding and view synthesis <a href="/PhD_Thesis.pdf">[thesis]</a>.  
